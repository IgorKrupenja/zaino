...
import { ColorName } from '../../web-app/constants/Colors';
import Item from '../types/Item';
import Label from '../types/Label';

const inputFilePath = `./src/common/demo-data/input-data.csv`;
const outputFilePath = `./src/common/demo-data/output-data.json`;
